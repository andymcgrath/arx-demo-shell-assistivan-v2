...
const PRICING_OPTIONS: PricingOption[] = [
  ...
  },
  {
    ...
    price: 25,
    cadence: "/month",
    description: `Pay a reduced price by filling through the CoAssist Pharmacy — no separate insurance approval needed for this option. Recommended dosage: 18 mg orally twice daily approximately 12 hours apart with or without food.`,
    cta: "Enroll",
    badge: "Best Value",
  },
];
