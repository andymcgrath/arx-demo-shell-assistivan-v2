            ...
            <div className="flex flex-wrap gap-4 sm:gap-6">
              {MEDICATIONS.map((med) => (
                ...
                >
                  ...
                  <button className="flex items-center gap-2 bg-[#007178] text-white px-5 py-2 rounded-full font-semibold text-base hover:bg-[#03656B] flex-shrink-0 justify-center w-full sm:w-auto">
                    Start
